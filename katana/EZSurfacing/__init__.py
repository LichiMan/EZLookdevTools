...
def create_EZ_viewer_settings(attribute_name):
    ...
    for attribute_value in attribute_values:
        ...
        cel_statement = '/root/world//*{attr("%s.value") == "%s"}' % (attribute_name, attribute_value)
...
def create_EZ_materials(attribute_name, assign_random_color = False ):
    ...
    for attribute_value in attribute_values:
        ...
        material_network.getParameter('name').setValue('Mtl_network_%s'%attribute_value,0)
        ...
        PxrSurface_nodeType_name.setExpression('"PxrSurface_"+getParent().getNodeName()',0)
