...
class MainWindow(MayaQWidgetDockableMixin, QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.btn_wireframe_color_projects = QtWidgets.QPushButton('per Surfacing Project')
        ...
        self.btn_material_color_objects.clicked.connect(EZSurfacing.set_materials_per_object)
